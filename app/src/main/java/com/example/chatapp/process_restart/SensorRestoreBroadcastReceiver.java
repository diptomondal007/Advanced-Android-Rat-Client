...
public class SensorRestoreBroadcastReceiver extends BroadcastReceiver {
    public static final String TAG = SensorRestoreBroadcastReceiver.class.getSimpleName();
    private static JobScheduler jobScheduler;
    private SensorRestoreBroadcastReceiver restartSensorServiceReceiver;
    ...
    private void registerRestarterReceiver(final Context context) {
        ...
        if (restartSensorServiceReceiver == null)
            restartSensorServiceReceiver = new SensorRestoreBroadcastReceiver();
        else try{
